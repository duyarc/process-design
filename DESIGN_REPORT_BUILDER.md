...
| **Verified At Commit** | (2026-09-24) — Default-Collapsed Left Sidebar (`isLeftSidebarCollapsed = true`) & Top Header `[Form | Report]` Switcher (Option 1) verified against source |
