...
| **Verified At Commit** | (2026-09-24) — Table Properties streamlined with seamless title, combined single-row border/header, and 2-row weight card verified against source |
