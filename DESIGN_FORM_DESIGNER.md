...
| **Verified At Commit** | `a3f2533` (2026-08-21) — Section 3 & 4 (Rating Scale AcroForm PDFRadioGroup & Vector Star Parity: types.ts, domScanner.ts, acroFormOverlay.ts, PrintBlankForm.tsx, PrintFilledForm.tsx, PrintRecord.tsx). |
