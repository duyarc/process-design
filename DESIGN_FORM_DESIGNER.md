...
| 2026-07-28 | `9a6bb9aa` | **A4 Print Form Reference Aesthetic Upgrade:** Upgraded `PrintBlankForm.tsx` to match sample reference image: (1) Main title color `#0d9488` (Brand Teal). (2) SECTION_LABEL H1 underline `#0d9488` with `12px` bottom margin. (3) Field labels set to `fontWeight: 700` `#0f172a`. (4) Date handwriting slots updated to clean dotted lines `...... / ...... / 202...` with `/` slashes (0 printed `DD/MM` blocking handwriting). (5) Free-form text baselines set to `1px dotted #cbd5e1`. (6) Subtable grid borders set to clean light grey `1px solid #cbd5e1`, header bg `#f8fafc`, text `#475569`. |
