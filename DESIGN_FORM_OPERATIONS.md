...
| 2026-08-26 | `CURRENT` | **Paper Form Replica & Sheet Pagination UX:** Integrated `getFormPages`, Paper Sheet Tab Bar (`[📄 Trang 1]` `[📄 Trang 2]`), keyboard shortcut navigation (`Alt+➔` / `Alt+⬅`), and sticky bottom pagination dock in `FormFiller.tsx`. Eliminates scroll fatigue on long forms while maintaining 100% 1:1 print/PDF match. |
